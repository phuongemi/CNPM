...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">THÔNG TIN XƯỞNG CUNG CẤP</h1>
			</div>
		</div><!--/.row-->
		<div class="row">
                   ...
                   <div class="row" style="margin:10px">
                    ...
                    <div class="row">
                        <div class="col-lg-2 " style="margin:5px; ">
                        	<a href="xuongcungcap.php"><input type="button" class="btn btn-secondary btn btn-danger"  style="margin-left:20px"value="Quay lại"/>
                        </div>
                        ...
                        <div class="col-lg-1" style="margin:8px">
                       		<a href="ql_xuongcungcap.php"><input type="button" class="btn btn-secondary btn btn-success" value="Sửa chi tiết"/>
                        </div>
                         <div class="col-lg-1" style="margin:9px">
                       		<input type="button" class="btn btn-secondary btn btn-danger" value="Xóa xưởng cung cấp"/>
                        </div>
                    </div>
				</div>
		</div>
