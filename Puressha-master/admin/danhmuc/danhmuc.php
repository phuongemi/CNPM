					...
					<div class="panel-body tabs">
											...
											<div class="panel-body">
												<table class="table table-hover table-active" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Váy</td>
                                                        <td>
                                                    <a href="chitietdanhmuc.php"><input type="button" class="btn btn-secondary btn btn-info" value="Xem"></a>
                        							<a href="ql_danhmuc.php"> <input type="button" class="btn btn-secondary btn btn-warning" value="Sửa"></a>
                        ...
                        <div class="row">
                        	...
                        	<div class="col-lg-1" style="margin:8px">
                         	...
                         	<a href="themnhanvien.php"><input type="button" class="btn btn-secondary btn btn-success" value="Thêm danh mục"/></a>
                       	 	</div>
                    	</div>
								</div>
							</div>
