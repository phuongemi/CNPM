	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<div class="panel panel-default">
					<div class="panel-heading">Thông tin chi tiết khách hàng</div>
                    <div class="panel-body">
                    
                    <div class="row" style="margin:10px">
                    	<div class="col-lg-3 " style="color:#0CF"><b>MÃ KHÁCH HÀNG<b></div>
                        <div class="col-lg-9">NV001</div>
                    </div>
                    <div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>TÊN KHÁCH HÀNG<b></div>
                        <div class="col-lg-9">Nguyễn Văn A</div>
                    </div>
                   <div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>NGÀY SINH<b></div>
                        <div class="col-lg-9">12-12-2021</div>
                    </div>
                   <div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>GIỚI TÍNH<b></div>
                        <div class="col-lg-9">Nam</div>
                    </div>
                    <div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>ĐẠI CHỈ<b></div>
                        <div class="col-lg-9">273, An Duong Vuong, Q5, HCM</div>
                    </div>
                   <div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>TRẠNG THÁI<b></div>
                        <div class="col-lg-9">ON</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-2 " style="margin:5px; ">
                        	<a href="khachhang.php"><input type="button" class="btn btn-secondary btn btn-danger"  style="margin-left:20px"value="Quay lại"/>
                        </div>
                        ...
                        <div class="col-lg-1" style="margin:7px">
                         ...
                         <div class="col-lg-1" style="margin:9px">
                    		<a href="ql_khachhang.php"><input type="button" class="btn btn-secondary btn btn-success" value="Cập nhật tài khoản"/></a>
                        </div>
                    </div>
				</div>
		</div>
