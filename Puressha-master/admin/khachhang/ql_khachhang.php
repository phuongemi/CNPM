		...
		<div class="row">
			...
			<div class="panel panel-default">
                    ...
                    <div class="row" style="margin:10px">
                        ...
                        <div class="col-lg-9">
                        	<input type="Text" class="form-control" name="idD" placeholder="Mã khách hàng" disabled>
                        </div>
                    </div>
                    <div class="row" style="margin:10px; margin-bottom:20px;">
                    	<div class="col-lg-3 " style="color:#0CF"><b>TÊN KHÁCH HÀNG<b></div>
                        <div class="col-lg-9">
							<input type="text" class="form-control" name="idD" placeholder="Tên khách hàng">
                    	 </div>
                   </div>
                   ...
                   <div class="row" style="margin:10px">
                        ...
                        <div class="col-lg-9">
                        	...
                        	<input class="form-check-input" style="margin-left:20px;" type="radio" name="checkout" id="gt" value="nu" checked>
                    ...
                    <div class="row">
                        <div class="col-lg-2 " style="margin:5px; ">
                        	<a href="chitietkhachhang.php"><input type="button" class="btn btn-secondary btn btn-danger"  value="Cancel"/>
                        </div>
