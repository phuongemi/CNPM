		...
		<div class="row">
			...
			<div class="panel panel-default">
                   ...
                   <div class="row" style="margin:10px">
                        ...
                        <div class="col-lg-9">XXXX XXXX XXXX</div>
                    </div>
                    <div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>EMAIL<b></div>
                        <div class="col-lg-9">nguyenvana@gmail.com</div>
                    </div>	
					<div class="row" style="margin:10px">
                    	<div class="col-lg-3" style="color:#0CF"><b>CHỨC VỤ<b></div>
                        <div class="col-lg-9">Quản lý</div>
                    </div>	
					</div>
					
                    <div class="row">
                        <div class="col-lg-2 " style="margin:5px; ">
                        	<a href="nhanvien.php"><input type="button" class="btn btn-secondary btn btn-danger"  style="margin-left:20px"value="Quay lại"/>
                        </div>
                        ...
                        <div class="col-lg-1" style="margin:8px">
                       		<a href="ql_nhanvien.php"><input type="button" class="btn btn-secondary btn btn-success" value="Sửa nhân viên"/>
                        </div>
                         <div class="col-lg-1" style="margin:9px">
                       		<input type="button" class="btn btn-secondary btn btn-danger" value="Xóa nhân viên"/>
                        </div>
                    </div>
				</div>
		</div>
