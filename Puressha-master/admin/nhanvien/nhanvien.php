					...
					<div class="panel-body tabs">
											...
											<div class="panel-body">
												<table class="table table-hover table-active" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Quản lý</td>
                                                        <td>
                                                        <a href="chitietnhanvien.php"> <input type="button" class="btn btn-secondary btn btn-warning" value="Xem">
                                                     </td>
                                                     </tr>
                                                     <tr>
                                                    	<td>NV002</td>
                        ...
                        <div class="row">
                        	...
                        	<div class="col-lg-1" style="margin:8px">
                         	...
                         	<a href="themnhanvien.php"><input type="button" class="btn btn-secondary btn btn-success" value="Thêm nhân viên"/></a>
                       	 	</div>
                    	</div>
								</div>
							</div>
